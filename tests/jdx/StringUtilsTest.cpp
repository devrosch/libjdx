...
TEST_CASE("left trims white space", "[util][trimLeft]")
{
    ...
    libjdx::jdx::util::trimLeft(actual);
...
TEST_CASE("right trims white space", "[util][trimRight]")
{
    ...
    libjdx::jdx::util::trimRight(actual);
...
TEST_CASE("white spaces recognized", "[util][isSpace]")
{
    ...
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(0)));
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(1)));
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(2)));
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(3)));
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(4)));
    REQUIRE(libjdx::jdx::util::isSpace(actual.at(5)));
    REQUIRE_FALSE(libjdx::jdx::util::isSpace(actual.at(6)));
    REQUIRE_FALSE(libjdx::jdx::util::isSpace(actual.at(7)));
    REQUIRE_FALSE(libjdx::jdx::util::isSpace(actual.at(8)));
    REQUIRE_FALSE(libjdx::jdx::util::isSpace(actual.at(9)));
}
...
TEST_CASE("lower case letters for ASCII produced", "[util][toLower]")
{
    ...
    libjdx::jdx::util::toLower(actual);
...
TEST_CASE("splits string without trimming", "[util][split]")
{
    ...
    const auto output = libjdx::jdx::util::split(fixture, ",");
...
TEST_CASE("splits string with trimming", "[util][split]")
{
    const std::string fixture{"  this, is , a ,test   "};
    const std::vector<std::string> expected{"this", "is", "a", "test"};
    const auto output = libjdx::jdx::util::split(fixture, ",", true);
...
TEST_CASE("split returns full string if no delimiter present", "[util][split]")
{
    ...
    const auto output = libjdx::jdx::util::split(fixture, ",", false);
